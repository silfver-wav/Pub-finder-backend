    ...
    http
        ...
        .authorizeHttpRequests(req ->
            req.requestMatchers(WHITE_LIST_URL)
                ...
                .requestMatchers(HttpMethod.PUT, "/user/edit")
                .hasAnyAuthority(ADMIN.name(), USER.name())
                .requestMatchers(HttpMethod.DELETE, "/user/delete")
                .hasAnyAuthority(ADMIN.name(), USER.name())
                .requestMatchers(HttpMethod.GET, "/user/getVisitedPubs/**")
                .hasAnyAuthority(ADMIN.name(), USER.name())
                .requestMatchers(HttpMethod.GET, "/user/reviews/**")
                .hasAnyAuthority(ADMIN.name(), USER.name())

                .requestMatchers(HttpMethod.POST, "/visited/save/**")
                .hasAnyAuthority(ADMIN.name(), USER.name())
                .requestMatchers(HttpMethod.POST, "/visited/delete/**")
                .hasAnyAuthority(ADMIN.name(), USER.name())

                .requestMatchers(HttpMethod.POST, "/review/save/**")
                .hasAnyAuthority(ADMIN.name(), USER.name())
                .requestMatchers(HttpMethod.DELETE, "/review/delete/**")
                .hasAnyAuthority(ADMIN.name(), USER.name())
                .requestMatchers(HttpMethod.PUT, "/review/edit")
                .hasAnyAuthority(ADMIN.name(), USER.name())
        ...
        .addFilterBefore(new AuthenticationFilter(authenticationService, userDetailsService),
