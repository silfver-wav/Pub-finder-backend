...
public class PubsControllerTest {
    ...
    public void getPubsTest() throws Exception {
        ...
        mockMvc.perform(get("/pub/getPubs/{lat}/{lng}/{radius}", 1.0, 1.0, 1.0)).andExpect(status().isOk()).andExpect(content().json(new ObjectMapper().writeValueAsString(pubs)));
    }
    ...
    public void getPubByNameTest() throws Exception {
        ...
        mockMvc.perform(get("/pub/getPub/{name}", "name")).andExpect(status().isOk()).andExpect(content().json(new ObjectMapper().writeValueAsString(pub)));
    }
    ...
    public void savePubTest() throws Exception {
        ...
        mockMvc.perform(post("/pub/savePub").contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(pub)))
    ...
    public void savePubTest_BAD_REQUEST() throws Exception {
        ...
        mockMvc.perform(post("/pub/savePub").contentType(MediaType.APPLICATION_JSON))
